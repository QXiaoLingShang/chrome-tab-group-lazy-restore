...
- **Protected group names**: Add group names in the final input row. Press Enter or leave the field to confirm an entry. Tabs in groups whose names exactly match a name in this list are not discarded.
