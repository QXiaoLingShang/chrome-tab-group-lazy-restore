...
const englishMessages = {
  ...
  minimumTabCountDescription: "Groups with this many tabs or fewer are not discarded.",
  ...
  waitForTabTitlesAriaLabel: "Wait for tab titles before discarding",
  waitForTabTitlesWarning:
    "Experimental: while a Group is opening, waiting for titles can keep memory usage high for longer.",
  groupAllowlist: "Group name allowlist",
  groupAllowlistDescription:
    "Tabs in groups whose names exactly match an entry are not discarded.",
  addGroupToAllowlistAriaLabel: "Add a group name to the allowlist",
  showMoreGroups: "Show more groups",
  showLessGroups: "Show less groups",
  allowlistedGroupTitleAriaLabel: "Group name on the allowlist {index}",
  removeAllowlistedGroupAriaLabel: "Remove group from the allowlist: {title}",
  addGroupPlaceholder: "Add group name",
  addAllowlistedGroupAriaLabel: "Add a group name to the allowlist",
  duplicateGroupError: "This group name is already on the allowlist.",
  advancedSettings: "Advanced restore and discard settings",
  advancedSettingsDescription:
    "Adjust the timing and concurrency limits used to detect restored Groups and discard background Tabs.",
  restoreDetectionWindow: "Restore detection window (ms)",
  restoreDetectionWindowDescription:
    "How long after a Tab is created it can still be associated with a Group restore batch.",
  detectionCleanupMargin: "Detection cleanup margin (ms)",
  detectionCleanupMarginDescription:
    "Extra time after the detection window before tracking for an unmatched new Tab is removed.",
  groupInspectionDelay: "Group inspection delay (ms)",
  groupInspectionDelayDescription:
    "How long to wait after Tabs join a Group before checking for discard candidates.",
  restoreBatchLifetime: "Restore batch lifetime (ms)",
  restoreBatchLifetimeDescription:
    "Maximum time a restore batch stays active; it also caps how long title waiting can continue.",
  discardStartGap: "Discard start gap (ms)",
  discardStartGapDescription:
    "Delay before starting another discard operation after one finishes.",
  retryDelay: "Retry delay (ms)",
  retryDelayDescription:
    "Maximum wait before checking a title again or retrying a transient discard failure; limited by the batch lifetime.",
  maximumDiscardRetries: "Maximum discard retries",
  maximumDiscardRetriesDescription:
    "Maximum retries for a failed tab discard, excluding title-wait retries.",
